...
1. `docs/reviewer-packet.md` (compact audit entry),
2. `docs/claim-map.md` (dependency structure),
3. `notes/known-gaps.md` (explicit open bridges),
4. `manuscript/main.tex` (primary formal record).

If helpful, even a short note pointing to the highest-risk step(s) would be valuable.
