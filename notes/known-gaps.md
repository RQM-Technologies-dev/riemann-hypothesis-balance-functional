...
- If this coverage clause is not theorem-level, initialization (`lem:b4-delta-initialization-seed`) plus structural non-increase (`lem:b4-delta-structural-nonincrease`) does not force the classwise quantifier needed by `lem:b4-first-delta-control`.
